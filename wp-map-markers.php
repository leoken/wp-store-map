...
/*
  ...
  Plugin URI: http://maintainweb.co
...
function wpmm_fetch_stores( $map ) {
	...
	foreach ( $locations as $location ) {
		...
		$store_phone = sanitize_text_field( get_post_meta( $location->ID, 'phone', true ) );
		$store_email = sanitize_text_field( get_post_meta( $location->ID, 'email', true ) );
		$store_territories = sanitize_text_field( get_post_meta( $location->ID, 'territories', true ) );
		$store_products = sanitize_text_field( get_post_meta( $location->ID, 'products', true ) );
		$store_marker = '/media/map-marker-afc-grey.png';
